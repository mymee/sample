 ...
 */
package com.sbsch.cms.sample.email;

import com.sbsch.cms.framework.util.email.MailInfo;
import com.sbsch.cms.framework.util.email.SendMail;
import com.sbsch.cms.framework.util.email.util.MailConts;
