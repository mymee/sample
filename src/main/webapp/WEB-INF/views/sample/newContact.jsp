	...
	<table style="border-collapse: collapse;" bgcolor="lightblue"
		...
		<tbody>
			...
			<tr valign="top" align="center">
				<td align="center"><form:form action="newContact.do"
						method="post" modelAttribute="newContact" id="contactForm">
						...
						<table style="border-collapse: collapse;" width="500" border="0"
							...
							<tbody>
								<tr>
									...
									<td width="150"><form:input path="id"
											cssClass="required" ></form:input></td>
									<td align="left"><form:errors path="id" cssClass="error"></form:errors>
									</td>
								</tr>
								<tr>
									<td width="100" align="right">Name</td>
									<td width="150"><form:input path="name"
											cssClass="required" minlength="2"></form:input></td>
									<td align="left"><form:errors path="name" cssClass="error"></form:errors>
									</td>
								</tr>
								<tr>
									<td width="100" align="right">Date</td>
									<td><form:input path="dob"></form:input> <br>ex)dd-mm-yyyy
									</td>
								...
								<tr>
									<td colspan="3" align="center"><input name="" value="Save"
										type="submit" /> <input name="" value="Reset" type="reset" />
										<input value="Back"
